## Problem statement:
Everyone using spec driven development says “just use the largest model”.  It’s expensive and overkill.

## Proposal:
A spec driven development setup that’s light enough for daily driving in medium models.
